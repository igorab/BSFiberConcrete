...
namespace BSFiberConcrete
{
    ...
    internal class BSFiberCalc_Cracking : IBSFiberCalculation
    {
        ...
        public bool CalculateUltM()
        {
            ...
            resultDictionary.Add("Момент образования трещин с учетом неупругих деформаций растянутого сталефибробетона, Mcrc [кг*см2] [СП 360 П6.2.8]", M_crc);
            resultDictionary.Add("Коэффициент использования по второй группе предельных состояний [СП 360 П6.2.4]", My/M_crc);
        ...
        public bool CalculateWidthCrack()
        {
            ...
            resultDictionary.Add("Ширина раскрытия трещин от действия внешней нагрузки, a_crc [см] [СП 360 П6.2.14]", a_crc);
            resultDictionary.Add("Предельно допустимая ширина раскрытия трещин, acrc_ult [см] [СП 360 П6.2.6]", a_crc_ult);

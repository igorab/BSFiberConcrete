...
namespace BSFiberConcrete
{
    ...
    public class BSMatConcrete : IMaterial, INonlinear, INotifyPropertyChanged
    {
        ...
        private DeformDiagramType _TypeDiagram;
        ...
        public DeformDiagramType TypeDiagram
        {
        ...
        /// <summary>
        /// Модуль упругости бетона на сжатие
        /// </summary>
        /// 
        ...
        private void ChangeBetonIndex()
        {
            ...
            Rb_n = m_Beton[_betonIndex].Rbn;
            Rb = m_Beton[_betonIndex].Rb;

            Rbt_n = m_Beton[_betonIndex].Rbtn;
            Rbt = m_Beton[_betonIndex].Rbt;

            

            //TODO Временная мера, чтобы совпадала размерность с напряжениями
            // Необходимо переписать базу данных.
            Eb = m_Beton[_betonIndex].Eb * 1000;
            Rb1 = 0.6 * Rb;
            Eps_b1 = Rb1 / Eb;
        ...
        /// <summary>
        /// Изменить свойства объекта при изменении типа диаграммы деформирования
        /// </summary>
        private void ChangeBetonTypeDiagram()
        {

            if (_TypeDiagram == DeformDiagramType.D3Linear)
            {
                //R_b1 = 0.6 * Rb;
            }
            else // для случая двухлинейной диаграммы и др
            {
                //R_b1 = Rb;
            }
        }

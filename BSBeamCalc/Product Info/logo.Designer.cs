...
namespace CBAnsDes
{
    ...
    public partial class logo : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            MainLayoutPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 253.0f));
            ...
            Load += new EventHandler(logo_Load);
            ResumeLayout(false);
